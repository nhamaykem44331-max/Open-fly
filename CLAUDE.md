# CLAUDE.md — OpenFly Development Guidelines
...
Tài liệu này định nghĩa **quy tắc hành vi** cho Claude Code (và bất kỳ AI agent nào) khi làm việc trong dự án OpenFly. **Áp dụng xuyên suốt toàn bộ quá trình triển khai** từ Sprint 0 đến launch và sau đó.
...
Vì OpenFly là solo dev + Claude Code, KHÔNG có teammate để pair review. Claude phải đóng vai "second pair of eyes":
